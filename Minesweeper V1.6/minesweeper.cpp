...
bool Minesweeper::insertBomb(Location firstDig){
    ...
    if(isFlaged_[firstDig.row_][firstDig.col_]){
        cout << "\n";
        cout << "Invalid input, couldn't dig has-been-flaged location" << endl;
        return false;
    }
    srand(time(0));
    ...
    for(int i = 0; i < min(rowSize_ * colSize_, 900); i++){
        ...
        cout << "rowRandom = " << rowRandom << endl;
        cout << "colRandom = " << colRandom << endl;
        cout << "minesweeperNumArr_[rowIndex][colIndex] = " << minesweeperNumArr_[rowIndex][colIndex] << endl;
        cout << "minesweeperNumArr_[rowRandom][colRandom] = " << minesweeperNumArr_[rowRandom][colRandom] << endl;
        */
